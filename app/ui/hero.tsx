	...
	return (
		<div className='w-full h-120 flex flex-col items-center justify-center   space-y-8'>
			...
			<p className='text-lg text-lightSubtitle dark:text-darkSubtitle p-0 m-0 w-2/5 text-center '>
				I design captivating user interfaces and engineer innovative web <br />
				experiences. Passionate about merging aesthetics with intelligence, I am
				on a journey to contribute to the future of AI technology.
			</p>
